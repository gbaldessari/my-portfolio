...
export const projects: Project[] = [
  ...
  },
  {
    ...
    tags: ['React', 'TypeScript', 'NestJS', 'MongoDB', 'Google Maps API', 'WhatsApp Cloud API', 'Vercel', 'Railway'],
    description:
      'Diseñé e implementé de forma integral una plataforma web para la gestión comercial y operativa de una empresa distribuidora, orientada a la administración de catálogos de productos y ofertas, geolocalización de clientes y sectores territoriales, captura y validación de datos comerciales, y alertas automáticas de vencimiento de lotes. Definí la arquitectura del sistema (monorepo con frontend SPA, backend REST y API de integración), implementé autenticación por roles, generación asíncrona de catálogos PDF, carga masiva de datos e integraciones con <b>WhatsApp Cloud API</b> y <b>WooCommerce</b>, y gestioné el despliegue productivo en <b>Vercel</b> y <b>Railway</b>.',
  ...
  },
  {
    ...
    tags: ['PHP', 'JavaScript', 'NestJS', 'TypeScript', 'MongoDB', 'Kommo', 'Odoo', 'Google Ads API', 'Make', 'Railway'],
    description:
  ...
  },
  {
    ...
    tags: ['React', 'TypeScript', 'NestJS', 'PostgreSQL', 'Socket.IO', 'Docker', 'Jenkins'],
    description:
      'Lideré el diseño e implementación de una aplicación web para la unidad operativa de control de tránsito de la region de Coquimbo, orientada al reporte georreferenciado de incidentes en vía pública, monitoreo en tiempo real y análisis histórico para la toma de decisiones operativas. Definí la arquitectura del sistema (monorepo con backend REST/WebSockets y frontend SPA), coordiné al equipo de desarrollo y gestioné el despliegue productivo en infraestructura local de la <b>UOCT</b> mediante <b>Docker Compose</b> y <b>Jenkins</b>.',
